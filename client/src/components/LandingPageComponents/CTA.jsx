        ...
        <div className="w-full bg-rose-300">
            <ul className="flex justify-evenly items-center text-xl text-black">
                ...
                <div className="w-1/5 relative h-full py-6">
                    ...
                    onClick={()=>setActive(1)}>
                        <GoTrophy size={"2rem"}/>Highest Quailty Ingredients
                        {active === 1 ? <CiCircleMinus size={"3rem"} style={{color:"rgb(251 113 133)"}}/> : <CiCirclePlus size={"3rem"} style={{color:"rgb(251 113 133)"}}/>}
                    </li>
                    <span className={active === 1? "absolute -bottom-1 right-1/2": "absolute -bottom-1 right-1/2 opacity-0"}><IoTriangle size={"1.5rem"} style={{color: "rgb(251 113 133)"}}/></span>
                </div>

                <div className="w-1/5 py-6 relative">
                    <li className="h-20 flex bg-white items-center justify-between px-4 text-center border-2 cursor-pointer rounded-full hover:scale-105 transition-all border-rose-400 shadow-md"
                    onClick={()=>setActive(2)}>
                        <AiOutlinePhone size={"2rem"}/>Amazing Customer Service
                        {active === 2 ? <CiCircleMinus size={"3rem"} style={{color:"rgb(251 113 133)"}}/> : <CiCirclePlus size={"3rem"} style={{color:"rgb(251 113 133)"}}/>}
                    </li>
                    <span className={active === 2? "absolute -bottom-1 right-1/2": "absolute -bottom-1 right-1/2 opacity-0"}><IoTriangle size={"1.5rem"} style={{color: "rgb(251 113 133)"}}/></span>
                </div>
                ...
                <div className="w-1/5 py-6 relative">
                    ...
                    <span className={active === 3? "absolute -bottom-1 right-1/2": "absolute -bottom-1 right-1/2 opacity-0"}><IoTriangle size={"1.5rem"} style={{color: "rgb(251 113 133)"}}/></span>
                </div>
                ...
                <div className="w-1/5 py-6 relative">
                    ...
                    <span className={active === 4? "absolute -bottom-1 right-1/2": "absolute -bottom-1 right-1/2 opacity-0"}><IoTriangle size={"1.5rem"} style={{color: "rgb(251 113 133)"}}/></span>
                </div>
